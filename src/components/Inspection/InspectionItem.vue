<template>
  <div class="border-2 border-[#0b84fe] p-5 rounded-sm">
    <div class="mb-2">
      <div class="flex">
        <h1 class="flex flex-row flex-1 space-x-2 font-bold">
          <svg
    ...
    <p class="text-xs text-gray-500 font-semibold text-justify">
      ...
      and verify specified barcode and optionally provide photographic evidence.
    </p>
    <!-- Dropdown -->
    <div
      class="text-sm font-semibold flex flex-col space-y-2 border-2 border-gray-400 p-2 w-48 z-50 bg-white"
    >
